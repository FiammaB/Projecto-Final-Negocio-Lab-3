...
export class PedidoController {
    constructor() {
        ...
        this.getByNroComprobante = async (req, res) => {
            try {
        ...
        this.getByDateRange = async (req, res) => {
            try {
            ...
            try {
                ...
                pedidos.forEach((pedido) => {
                    ...
                    pedido.detalles.forEach((detalle) => {
                        doc.text(`Producto: ${detalle.producto?.denominacion} (Código: ${detalle.producto?.codigoProducto})`);
                        doc.text(`Cantidad: ${detalle.cantidad} - Precio Unitario: $${detalle.producto?.precioVenta} - Subtotal: $${detalle.subtotal}`).moveDown();
                    });
